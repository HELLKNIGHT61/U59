...
public class AnimatorManager : MonoBehaviour
{
    ...
    private void OnAnimatorMove()
    {
        if (playerManager.isUsingRootMotion)
        {
            ...
            Vector3 v3; //= new Vector3(inputManager.horizontalInput,0, inputManager.verticalInput);
            //v3 = transform.TransformDirection(v3);
            //v3.Normalize();

            v3 = playerLocomotion.playerRigidbody.velocity;
            v3.y = 0;
            v3.Normalize();
            playerLocomotion.playerRigidbody.AddForce(v3 * 1.3f);
