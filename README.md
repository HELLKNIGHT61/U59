...
- **Sprint Retrospective:**
  ...
  - Hedeflenen projenin beklenenden daha zor (meşakkatli) çıkması ve takım üyelerinin özel hayatlarındaki istenmeyen aksilikler ile teknik aksaklıklar nedeniyle proje sadece prototip düzeyde geliştirilebilmiştir. Ancak bu durum gelecekte de geliştirebileceği (devam ettirilebileceği) anlamını taşımaktadır.
